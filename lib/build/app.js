...
var _canvas_cell = __webpack_require__(7);
...
var Canvas = function () {
  ...
  _createClass(Canvas, [{
    ...
    value: function resetNodes() {
      ...
      for (var i = 0; i < 80; i++) {
        this.nodes.push(new _canvas_cell2.default(this.radius / 2));
      }
    }
  }, {
    key: 'draw',
...
var CanvasCell = function () {
  function CanvasCell(radius) {
    ...
    this.diam = radius * 2;
    this.x = Math.floor(Math.random() * window.innerWidth / this.diam) * this.diam;
    this.y = Math.floor(Math.random() * window.innerHeight / this.diam) * this.diam;
    ...
    this.start = (0, _utils.SelectFrom)(0, 1, 2, 3) * Math.PI * 0.5;

...
class CanvasCell {
  constructor(radius) {
    ...
    this.colour = Math.random() > 0.75
      ? `rgb(${Math.floor(64 + 32 * Math.random())}, ${Math.floor(64 + 32 * Math.random())}, ${Math.floor(184 + 32 * Math.random())})`
      : `rgb(32, 32, ${Math.floor(184 + 32 * Math.random())})`;
